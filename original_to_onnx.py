#!/usr/bin/env python3
"""
Convert both original and trained models to ONNX format for optimization
"""
...
def convert_model_to_onnx(model_path, output_path, model_name):
    ...
    Args:
        model_path: Path to input .pth model
    ...
    try:
        ...
        # Create dummy input (1024x1024 for best compatibility)
